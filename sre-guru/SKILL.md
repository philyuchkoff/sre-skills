...
|-------|----------------|
| `sre-auditor` | Когда нужен формальный аудит и SRE.md отчёт |
| `sre-architect` | Когда нужно стратегическое проектирование |
| `sre-slx` | Когда нужны SLO/SLI/Error Budget |
