...
trigger: |
  ...
  - Прямом запросе: "SRE audit", "аудит надежности", "как sre", "проанализируй надежность"
...
|-------|----------------|
| `sre-guru` | Для тактической консультации по конкретным вопросам |
| `sre-architect` | Для стратегического проектирования observability, PRR |
| `sre-slx` | Для генерации SLO-документов после утверждения SLO |
